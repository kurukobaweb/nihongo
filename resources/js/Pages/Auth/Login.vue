    ...
    <main class="min-h-screen bg-slate-950 text-slate-100">
        <section class="mx-auto flex min-h-screen w-full max-w-md flex-col justify-center px-6 py-12">
            <div>
                ...
                <h1 class="mt-3 text-3xl font-semibold tracking-normal">ログイン</h1>
                <p class="mt-3 text-sm leading-6 text-slate-300">
                    メールアドレスとパスワードで学習を再開します。
                </p>
            </div>
            ...
            <p class="mt-6 text-sm text-slate-300">
                アカウントがない場合は
                <Link href="/register" class="font-medium text-emerald-300 hover:text-emerald-200">新規登録</Link>
                へ進んでください。
            </p>
        </section>
    </main>
